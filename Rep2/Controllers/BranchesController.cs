...
namespace Rep2.Controllers
{
    public class BranchesController : Controller
    {
        ...
        {
            var branches = db.Branches.Include(b => b.BranchType);
        ...
        {
            ViewBag.TypeID = new SelectList(db.BranchTypes, "TypeID", "TypeName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BranchID,BranchName,TypeID,Code")] Branch branch)
        {
            if (ModelState.IsValid)
            {
